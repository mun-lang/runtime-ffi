...
namespace mun {
    ...
    public:
        ...
        bool is_err() noexcept {
            return std::holds_alternative<error_type>(m_variant);
        }
         ...
         */
        error_type&& unwrap_err() noexcept {
    ...
    public:
         ...
         * \param success the output of a successful function invocation
         */
        explicit InvokeResult(std::monostate monostate)
            : m_variant(std::move(monostate)) {}
